...
const ManageUsers = () => {
  ...
  const [stats, setStats] = useState({ total: 0, stockmanager: 0, billcounter: 0 });
  ...
  // Form states
  const [formData, setFormData] = useState({ username: '', email: '', password: '', role: 'billcounter' });
  ...
  const resetForm = () => { 
    setFormData({ username: '', email: '', password: '', role: 'billcounter' }); 
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-gray-600">Manage stockmanagers and billcounters</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 truncate">Stock Managers</h3>
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">{stats.stockmanager}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-900 truncate">Bill Counters</h3>
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-600">{stats.billcounter}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full text-sm sm:text-base"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white min-w-0 text-sm sm:text-base"
              >
                      ...
                      <tr key={user._id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                            ...
                            {user.role === 'stockmanager' ? 'Stock Manager' : 'Bill Counter'}
                          </span>
                        </td>
