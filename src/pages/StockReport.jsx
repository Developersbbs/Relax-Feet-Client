...
const StockReport = () => {
  ...
  const exportToCSV = () => {
    const headers = ['Name', 'Category', 'Price', 'Quantity', 'Total Value', 'Stock Status'];
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {/* Total Products Card */}
        <div className="p-6 rounded-xl border bg-white border-gray-200 hover:border-gray-300 shadow-sm transition-all duration-300 hover:transform hover:scale-105">
          <div className="flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="p-6 rounded-xl border bg-white border-gray-200">
          ...
          <div className="h-80 flex flex-col justify-center items-center">
            <div className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-pink-500 bg-clip-text text-transparent mb-4">
      ...
      {/* Filters Section */}
      <div className="p-6 rounded-xl border mb-6 backdrop-blur-sm bg-white border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-1 lg:flex-none lg:justify-end">
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full transition-all duration-200 bg-white border-gray-300 text-gray-900 placeholder-gray-500 border"
              />
            </div>
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none w-full transition-all duration-200 bg-white border-gray-300 text-gray-900 border"
              >
