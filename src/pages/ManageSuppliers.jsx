    ...
    <div className="p-4 sm:p-6 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 transition-colors duration-300">
          <div className="flex items-center">
            <Building className="w-10 h-10 text-orange-600 mr-4" />
            <div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-2">
                        <button
                          ...
                          className="text-orange-600 hover:text-blue-900 p-1 rounded transition-colors"
                          title="View"
                        >
                    ...
                    <button
                      ...
                      className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                        pagination.page === page
                          ? 'z-10 bg-blue-50 border-blue-500 text-orange-600'
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-4xl my-8 max-h-[85vh] overflow-y-auto">
                      ...
                      {formData.products.map((product, index) => (
                        <span key={index} className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded flex items-center">
                          ...
                          <button
                            ...
                            className="ml-1 text-orange-600 hover:text-blue-800"
                          >
                            ×
                          </button>
                        </span>
