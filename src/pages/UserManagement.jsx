  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 transition-colors duration-300">
          <div className="flex items-center">
            <Users className="w-8 h-8 sm:w-10 sm:h-10 text-orange-600 mr-3 sm:mr-4" />
            <div className="min-w-0 flex-1">
              <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-slate-100 truncate">
                Total Users
              </h3>
              <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600">{stats.total}</p>
            </div>
          </div>
        </div>
      ...
      {/* Filters and Actions */}
      <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 mb-4 sm:mb-6 transition-colors duration-300">
      ...
      {/* Users Display */}
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md border border-gray-200 dark:border-slate-700 overflow-hidden transition-colors duration-300">
        {loading ? (
            ...
            <div className="lg:hidden">
              {filteredUsers.length === 0 ? (
                ...
                <div className="divide-y divide-gray-200 dark:divide-slate-700">
                  {filteredUsers.map((user) => (
                    <div key={user._id} className="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
