      ...
      <section className="bg-white border border-slate-200 rounded-xl shadow-sm">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center py-20 px-6">
            <ExclamationTriangleIcon className="mx-auto h-12 w-12 text-amber-500 animate-pulse mb-4" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2 mt-3">
                  ...
                  {!item.isRead && (
                    ...
                    >
                      {loadingActions.has(item._id) ? (
                        <>
                          <div className="w-4 h-4 border border-amber-700 border-t-transparent rounded-full animate-spin"></div>
                          <span>Reading...</span>
                        </>
                      ) : (
                        <>
        ...
        {meta && meta.totalPages > 1 && (
          <footer className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 px-4 sm:px-6 py-4 border-t border-slate-200 bg-slate-50">
            <button
              ...
              disabled={page <= 1}
              className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-600 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60 min-h-[44px] min-w-[100px] justify-center touch-manipulation"
            >
      ...
      {isPopupOpen && selectedNotification && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen p-4 text-center">
            ...
            {/* Modal panel */}
            <div className="relative inline-block w-full max-w-2xl p-0 bg-white rounded-xl text-left overflow-hidden shadow-2xl transform transition-all align-middle">
              {/* Header */}
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-4 sm:px-6 py-3 sm:py-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="p-1.5 sm:p-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-lg transition-colors duration-200">
                  ...
                  <button
                    type="button"
                    onClick={handleClosePopup}
                    className="p-1.5 sm:p-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-colors touch-manipulation"
                  >
